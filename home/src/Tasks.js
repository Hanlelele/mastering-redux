...
function Tasks() {
    ...
    const storedTaks = readStoredTasks();
    const [tasks, setTasks] = useState(storedTaks.tasks);
    const [completedTasks, setCompletedTasks] = useState(storedTaks.completedTasks);
